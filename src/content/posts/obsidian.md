...
image: https://i0.hdslb.com/bfs/openplatform/ce961d72977b6695f0b6d8ac037676b6b82c38de.png
tags:
  - Obsidian
  - Markdown
draft: false
...
![](https://i0.hdslb.com/bfs/openplatform/d0d7562707abba05bd339cd998c47082ecc63cd5.png)
然后点击 **管理仓库** ，然后根据你所需要的情况进行选择
![](https://i0.hdslb.com/bfs/openplatform/bc45df734819b6120336af6cfa91ab381ee82bf2.png)
...
点击 **设置** 
![](https://i0.hdslb.com/bfs/openplatform/27a439c22ff4cdb0e657e7d4982bf9c4829d5899.png)
如图配置，这样我们就解决了第一个问题
![](https://i0.hdslb.com/bfs/openplatform/16340dc616cfd58505c95431aa243dba17ad7f0d.png)
...
![](https://i0.hdslb.com/bfs/openplatform/f06d1565bd938f83ff9806bd6235b03183cf9f70.png)
接下来，尝试使用任一截图工具，如 **QQ截图** ，截图后使用 **Ctrl+V** 粘贴进文章，你应当能看到类似这样的图片链接了
```bash
![](https://i0.hdslb.com/bfs/openplatform/ce961d72977b6695f0b6d8ac037676b6b82c38de.png)
```
# 黑曜石如何强大？
`published` 字段可以通过点点点实现
![](https://i0.hdslb.com/bfs/openplatform/9b162d97a53b442c5ac465562d6467bf0d00a230.png)
通用字段可以直接填充曾经写过的
![](https://i0.hdslb.com/bfs/openplatform/8f40957ea1709212eaa8558c1dcbc2d2a7ac4d24.png)
`tags` 字段只需要你专注于标签，无需再手动管理格式
![](https://i0.hdslb.com/bfs/openplatform/325e04943831c89fb7a0e17d386cbfde952919d8.png)
布尔字段通过勾选来处理 `true` 和 `false`
![](https://i0.hdslb.com/bfs/openplatform/e0c08e4fd16dcc5351c192b07a63b81c0d0e73f9.png)
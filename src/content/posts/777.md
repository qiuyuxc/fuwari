...
custom_summary: 本文介绍如何借助华为云 DNS 的线路分流能力，结合 Vercel、Netlify、Cloudflare 等平台以及第三方优选域名，实现按运营商分流访问，并提升不同网络环境下的网站可达性与访问速度。
...
这篇文章主要介绍一种比较实用的思路：借助 **华为云 DNS 的线路解析能力**，结合第三方优选域名，对不同平台进行优选与分流。这样可以让不同运营商用户访问到更合适的线路，从而改善站点的可达性与访问速度。
...
5. [华为云国际站](https://auth.huaweicloud.com/authui/login.html?service=https%3A%2F%2Fconsole-intl.huaweicloud.com%2Fdns%2F%3FagencyId%3Df03fc6c78ad640679dce46d3caa233b9%26region%3Dap-southeast-1%26locale%3Dzh-cn%26cloud_route_state%3D%2Fdns%2Fdashboard&locale=zh-cn#/login "华为云国际站")
...
完成添加后，Vercel 会给出默认的解析记录。先按平台要求正常完成绑定与生效。

![](/assets/image/7771.webp)
...
拿到优选域名之后，将原解析值替换为对应的优选目标即可。

### 测试优选是否生效

替换完成后，可以通过测试工具或实际访问方式，验证当前优选域名是否已经生效。

![](/assets/image/7772.webp)
...
配置完成后，可以再次进行测试，确认各线路是否已经正确命中预期平台。

![](/assets/image/77711.webp)
...
整体来说，这是一套比较适合折腾党、也比较适合多平台部署场景的方案。
...
image: ../img/2d9e67af8fbdb8cfc81dc0765d0825b4.png
tags: [AI绘图, NoobAI]
category: '教程'
draft: false 
lang: ''
...
![2025-05-13-11-58-34-image.png](../img/0e285313299dc759b33c7f896d825c88.png)

好在凭借着仅剩的记忆也是顺着这些蛛丝马迹把我曾经丢掉的知识找回来了，在纯小白的情况下，你可以跑出类似下面的图！（跑不出来你打死我！）


![2025-05-13-11-59-50-ComfyUI_00016_.png](../img/a8f1e5fa9ab7ffe2bb345a5175208c0f.png)

![2025-05-13-12-00-37-ComfyUI_00011_.png](../img/24c32d5ee1c25542b625b4a6070d8936.png)
...
![2025-05-13-12-08-17-image.png](../img/9f70e9aa9de8f61a5fe7cf03b3538f2c.png)
...
![2025-05-13-12-05-17-image.png](../img/fc1503517e0980377231eca2836e7c60.png)

点击右下角的开始运行，先让他进行初始化，直到它自动打开你的浏览器并且可以正常进入Comfyui的界面，如下图![2025-05-13-12-06-57-image.png](../img/3a0915464350ec2e7be15ea009c4bc13.png)

## 放置模型

将我们刚才下载的NoobAI-V预测模型，类似 `noobaiXLNAIXL_vPred10Version.safetensors` 这样的文件放到 `ComfyUI-aki-v1.5\models\checkpoints` 下面，如图

![2025-05-13-12-10-06-image.png](../img/df39a8fa50a6beaaa0bf98d76bf9bd97.png)

## 开始绘图

刷新Comfyui，你应该可以在 `Checkpoint加载器(简易)` 处可以看到你放置的所有模型，选择带有 `vPred...` 的就是V预测模型

![2025-05-13-12-11-55-image.png](../img/c2312822597369f9803da685585c36a2.png)
...
![2025-05-13-12-15-16-image.png](../img/6c1b8634affc2ef87f6a70ecd5d3d800.png)

复制 `Prompt tags` 

回到Comfyui，将其粘贴进链接了正面条件的CLIP文本编码器

![2025-05-13-12-16-35-image.png](../img/87c903c596a3e056542a3b0c8c212dc6.png)
...
![2025-05-13-12-19-32-image.png](../img/97e668fd546bcaa5b9c72583afd21a81.png)
...
![2025-05-13-12-22-06-image.png](../img/a12e6bb4972cb5f56b50f985ef6393c2.png)

最终工作流如图，然后点击执行队列！
![2025-05-13-12-24-12-image.png](../img/8d4e56da0ab7f90a972b45c51a65737b.png)

然后你就能得到一张这样的图片：![2025-05-13-12-24-51-ComfyUI_00018_.png](../img/24637fef16da95c39d0f6d6f9f946eea.png)

如果你想要图片是不同的样子请在正面提示词和反面提示词添加（**必须为英文！不知道的用翻译或者问AI！**）。比如我这边想要让足部放到焦点上并且裸足就添加**正面提示词**： `barefoot,feet in foreground`

![2025-05-13-12-27-07-ComfyUI_00019_.png](../img/fb5ee41648b11e617cb2642721b7e48a.png)
...
- 参考：[NoobAI-XL (NAI-XL) - V-Pred-0.5-Version | NoobAI Checkpoint | Civitai](https://civitai.com/models/833294?modelVersionId=1046043)。关于更多的此模型的技巧可以到图片对应处的About查看![2025-05-13-12-30-55-image.png](../img/415e669be861af3847f1142422240a24.png)
